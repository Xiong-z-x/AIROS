...
def generate_launch_description():
    ...
    sim = GroupAction(
        ...
        launch_configurations={
            ...
            'robot_mobility_profile': LaunchConfiguration('robot_mobility_profile'),
            'legged_champ_controller': LaunchConfiguration('legged_champ_controller'),
            'legged_cmd_vel_topic': LaunchConfiguration('legged_cmd_vel_topic'),
    ...
    terrain_planner = Node(
        ...
        parameters=[{
            ...
            'max_step_height': LaunchConfiguration('terrain_max_step_height'),
            ...
            'direct_waypoint_tolerance': LaunchConfiguration(
                'terrain_direct_waypoint_tolerance'
            ),
            ...
            'follow_path_start_clearance': LaunchConfiguration(
                'terrain_follow_path_start_clearance'
            ),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('terrain_goal_min_z', default_value='1.60'),
        DeclareLaunchArgument('terrain_goal_max_z', default_value='-1.0'),
        DeclareLaunchArgument('terrain_max_step_height', default_value='0.50'),
        DeclareLaunchArgument('terrain_direct_lookahead_dist', default_value='0.45'),
        DeclareLaunchArgument(
            'terrain_direct_waypoint_tolerance',
            default_value='0.42',
        ),
        ...
        TimerAction(period=13.0, actions=[fast_lio_localization_bridge]),
        ...
        TimerAction(period=25.0, actions=[slam_scan_projector]),
